...
public enum ResultEnum {
    ...
    // 用户相关
    FAIL_USER_ACCOUNT_EMPTY("10001", "账号为空"),
    FAIL_USER_ACCOUNT_EXIST("10002","账号已存在，请重新输入"),
    FAIL_USER_GET("10003","查询用户信息失败"),
    FAIL_USER_ADD_ERROR("10004","添加用户失败"),
    FAIL_USER_HANDLE_ERROR("10005","系统管理员禁止禁用"),
    FAIL_USER_ACCOUNT_ERROR("10022","用户名错误，用户名仅支持英文、数字、字符"),
    ...
    PATIENT_ID_MEDICARE_EMPTY("200014","就诊卡号为空"),
    PATIENT_PHONE_ERROR("20015","请输入正确的手机号"),
    PATIENT_ID_CARD_ERROR("20016","请输入正确的身份证号"),
    PATIENT_ID_MEDICARE_ERROR("20017","请输入正确的医保卡号"),
    // 排期相关(挂号)
    SCHEDULE_PARAM_EMPTY("20003","查询医生排期参数为空"),
    SCHEDULE_DOCTOR_EMPTY("20004","无可用就诊医生，请重新选择时间段"),
    SCHEDULE_SIGN_EMPTY("20008","请至少选择一个出诊时间段"),
    SCHEDULE_ADD_ERROR("20009","号源输入有误(请输入0-100范围)"),
    ...
    SCHEDULE_CHECK_SIGN_AM_ERROR("20018","该医生上午已排期,请重新选择"),
    SCHEDULE_CHECK_SIGN_PM_ERROR("20019","该医生下午已排期,请重新选择"),
    SCHEDULE_DELETE_ERROR("20021","删除失败，该出诊记录已有挂号信息！"),
    // 挂号信息管理相关(挂号)
    REGISTER_DEPARTMENT_ID_EMPTY("20005","就诊科室ID为空"),
    REGISTER_ID_CARD_ERROR("20013","请输入正确的身份证号"),
    REGISTER_FAIL("20014","挂号失败"),
    REGISTER_CHECK_ERROR("20020","该患者该时间段已挂过号，请重新选择"),
    // 就诊相关
